...
"[project]/app/goals/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GoalsPage() {
    ...
    const fetchGoals = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/goals');
            setGoals(res.data);
        } catch (err) {
            console.error(err);
        }
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/goals', formData);
            setFormData({
                name: '',
                target_amount: '',
                deadline: ''
    ...
    const handleAddFunds = async (goalId)=>{
        ...
        if (!amount) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/goals/${goalId}?amount_added=${amount}`);
            fetchGoals();
        } catch (err) {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    goal.deadline && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(GoalsPage, "t4RaFagGxLJ1/zZ9Wd9bcQL1tdQ=");
_c = GoalsPage;
var _c;
...
//# sourceMappingURL=_3a16f589._.js.map